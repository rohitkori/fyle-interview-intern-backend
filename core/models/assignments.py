...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(auth_principal.principal_id is not None or assignment.teacher_id == auth_principal.teacher_id, 'assignment was submitted to different teacher')
